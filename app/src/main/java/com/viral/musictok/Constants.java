package com.viral.musictok;

public class Constants {

    public static final String BASE_URL ="http://168.235.89.54/mobileapp_api/";
    public static final String API_KEY="156c4675-9608-4591-1111-00000";


    public static final String privacy_policy="https://viralup.io/privacy.html";
    public static final String terms_conditions="https://viralup.io/terms.html";
    ...
    public static final String Product_ID1="com.viral.musictoktwo";

    public static final String COINS2="2000";
    public static final String PRICE2="$20";
    public static final String Product_ID2="com.viral.musictokthree";

    public static final String COINS3="5000";
    public static final String PRICE3="$50";
    public static final String Product_ID3="com.viral.musictokfour";

    public static final String COINS4="10000";
    public static final String PRICE4="$100";
    public static final String Product_ID4="com.viral.musictokfive";
