package com.viral.musictok.ActivitesFragment.WalletAndWithdraw;
...
// && skuList.getPurchaseState()==Purchase.PurchaseState.PURCHASED
            ...
            } else if (Constants.Product_ID1.equals(skuList.getSkus().get(0)) && skuList.getPurchaseState() == Purchase.PurchaseState.PURCHASED) {
            ...
            } else if (Constants.Product_ID2.equals(skuList.getSkus().get(0)) && skuList.getPurchaseState() == Purchase.PurchaseState.PURCHASED) {
            ...
            } else if (Constants.Product_ID3.equals(skuList.getSkus().get(0)) && skuList.getPurchaseState() == Purchase.PurchaseState.PURCHASED) {
            ...
            } else if (Constants.Product_ID4.equals(skuList.getSkus().get(0)) && skuList.getPurchaseState() == Purchase.PurchaseState.PURCHASED) {
