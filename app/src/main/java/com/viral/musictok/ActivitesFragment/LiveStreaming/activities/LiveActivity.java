...
import com.viral.musictok.ActivitesFragment.LiveStreaming.LiveCommentModel;
import com.viral.musictok.ActivitesFragment.LiveStreaming.LiveCommentsAdapter;
import com.viral.musictok.ActivitesFragment.LiveStreaming.LiveUserModel;
import com.viral.musictok.ActivitesFragment.LiveStreaming.LiveUserViewAdapter;
import com.viral.musictok.ActivitesFragment.LiveStreaming.stats.LocalStatsData;
import com.viral.musictok.ActivitesFragment.LiveStreaming.stats.RemoteStatsData;
import com.viral.musictok.ActivitesFragment.LiveStreaming.stats.StatsData;
import com.viral.musictok.ActivitesFragment.LiveStreaming.ui.VideoGridContainer;
import com.viral.musictok.ActivitesFragment.SendGift.StickerGiftF;
import com.viral.musictok.ActivitesFragment.SendGift.StickerModel;
import com.viral.musictok.ApiClasses.ApiLinks;
import com.viral.musictok.Models.StreamShowHeartModel;
import com.viral.musictok.Models.UserOnlineModel;
import com.viral.musictok.SimpleClasses.OnSwipeTouchListener;
import com.viral.musictok.SimpleClasses.StreamingLikes.HeartView;
import com.volley.plus.VPackages.VolleyRequest;
import com.viral.musictok.Interfaces.AdapterClickListener;
import com.viral.musictok.Interfaces.FragmentCallBack;
...
public class LiveActivity extends RtcBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (com.viral.musictok.Constants.STREAMING_LIMIT) {
            try {
                if (userRole == Constants.CLIENT_ROLE_BROADCASTER) {
                    ...
                    }, com.viral.musictok.Constants.MAX_STREMING_TIME);
                }
            } catch (Exception e) {
                Log.d(com.viral.musictok.Constants.tag, "Exception streaming : " + e);
            }
        }
    }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    for (DataSnapshot joinSnapsot : dataSnapshot.getChildren()) {
                        Log.d(com.viral.musictok.Constants.tag, "Data JSON : " + joinSnapsot.getValue().toString());
    ...
    private void initUI() {
        ...
        Functions.printLog(com.viral.musictok.Constants.tag, "initUI");
        ...
        rtcEngine().setBeautyEffectOptions(isbeautyActivated,
                com.viral.musictok.ActivitesFragment.LiveStreaming.Constants.DEFAULT_BEAUTY_OPTIONS);
    ...
    private void initUserIcon() {
        Functions.printLog(com.viral.musictok.Constants.tag, "initUserIcon");
    ...
    private void initData() {
        Functions.printLog(com.viral.musictok.Constants.tag, "initData");
        mVideoDimension = com.viral.musictok.ActivitesFragment.LiveStreaming.Constants.VIDEO_DIMENSIONS[
    ...
    public void onFirstRemoteVideoDecoded(final int uid, int width, int height, int elapsed) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Functions.printLog(com.viral.musictok.Constants.tag, "onFirstRemoteVideoDecoded");
    ...
    private void renderRemoteUser(int uid) {
        Functions.printLog(com.viral.musictok.Constants.tag, "renderRemoteUser");
    ...
    public void onRtcStats(IRtcEngineEventHandler.RtcStats stats) {
        Functions.printLog(com.viral.musictok.Constants.tag, "onRtcStats");
        if (!statsManager().isEnabled()) return;
    ...
    public void onNetworkQuality(int uid, int txQuality, int rxQuality) {
        Functions.printLog(com.viral.musictok.Constants.tag, "onNetworkQuality");
        if (!statsManager().isEnabled()) return;
    ...
    public void onRemoteVideoStats(IRtcEngineEventHandler.RemoteVideoStats stats) {
        Functions.printLog(com.viral.musictok.Constants.tag, "onRemoteVideoStats");
        if (!statsManager().isEnabled()) return;
    ...
    public void onRemoteAudioStats(IRtcEngineEventHandler.RemoteAudioStats stats) {
        Functions.printLog(com.viral.musictok.Constants.tag, "onRemoteAudioStats");
        if (!statsManager().isEnabled()) return;
        ...
        if (streamerConnectCheckListener == null) {
            ...
            streamerConnectCheckListener = new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (connected) {
                        Log.d(com.viral.musictok.Constants.tag, "connected");
                        streamerTimer.cancel();
                    } else {
                        Log.d(com.viral.musictok.Constants.tag, "not connected");
                        streamerTimer.cancel();
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Log.w(com.viral.musictok.Constants.tag, "Listener was cancelled");
                }
            };
