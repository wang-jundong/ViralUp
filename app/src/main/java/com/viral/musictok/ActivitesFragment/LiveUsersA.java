...
import com.viral.musictok.ActivitesFragment.LiveStreaming.LiveUserAdapter;
import com.viral.musictok.ActivitesFragment.LiveStreaming.LiveUserModel;
import com.viral.musictok.ActivitesFragment.LiveStreaming.activities.LiveActivity;
...
public class LiveUsersA extends AppCompatLocaleActivity implements View.OnClickListener {
    ...
    public void openTicTicLive(String userId, String userName, String userImage, int role) {
        ...
        intent.putExtra(com.viral.musictok.ActivitesFragment.LiveStreaming.Constants.KEY_CLIENT_ROLE, role);
