...
import com.viral.musictok.ActivitesFragment.Accounts.LoginA;
import com.viral.musictok.ActivitesFragment.Accounts.ManageAccountsF;
import com.viral.musictok.ActivitesFragment.NewCoin.CoinBalanceA;
import com.viral.musictok.ActivitesFragment.Profile.Setting.AppLanguageChangeA;
import com.viral.musictok.ActivitesFragment.Profile.Setting.AppSpaceClearA;
import com.viral.musictok.ActivitesFragment.Profile.Setting.BlockUserListA;
import com.viral.musictok.ActivitesFragment.Profile.Setting.ManageProfileA;
import com.viral.musictok.ActivitesFragment.Profile.Setting.PrivacyPolicySettingA;
import com.viral.musictok.ActivitesFragment.Profile.Setting.ProfileVarificationA;
import com.viral.musictok.ActivitesFragment.Profile.Setting.PushNotificationSettingA;
import com.viral.musictok.ActivitesFragment.Profile.Setting.QrCodeProfileA;
import com.viral.musictok.ActivitesFragment.Profile.Setting.WalletPaymentA;
import com.viral.musictok.ActivitesFragment.VideoRecording.DraftVideosA;
import com.viral.musictok.ActivitesFragment.WebviewA;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tabBalance: {
                startActivity(new Intent(SettingAndPrivacyA.this, CoinBalanceA.class));
            }
            break;
            case R.id.tabQr: {
