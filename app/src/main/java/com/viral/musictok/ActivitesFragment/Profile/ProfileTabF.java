...
import com.viral.musictok.ActivitesFragment.LiveStreaming.activities.StreamingMain_A;
import com.viral.musictok.ActivitesFragment.NewCoin.CoinBalanceA;
import com.viral.musictok.ActivitesFragment.Profile.LikedVideos.LikedVideoF;
import com.viral.musictok.ActivitesFragment.Profile.PrivateVideos.PrivateVideoF;
import com.viral.musictok.ActivitesFragment.Profile.UserVideos.UserVideoF;
...
import com.viral.musictok.Models.PrivacyPolicySettingModel;
import com.viral.musictok.Models.PushNotificationSettingModel;
import com.viral.musictok.Models.UserModel;
import com.viral.musictok.R;
import com.viral.musictok.SimpleClasses.DataParsing;
import com.viral.musictok.SimpleClasses.Functions;
import com.viral.musictok.SimpleClasses.PermissionUtils;
...
public class ProfileTabF extends RootFragment implements View.OnClickListener {
    ...
    ImageView settingBtn, favBtn, coinBtn;

    protected TabLayout tabLayout;

    protected CustomViewPager2 pager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        NestedScrollView scrollView = (NestedScrollView) view.findViewById(R.id.nest_scrollviiew);
...
//                break;
    ...
    private void openCoinBalance() {
        Intent intent = new Intent(view.getContext(), CoinBalanceA.class);
        startActivity((intent));
        getActivity().overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
    }
