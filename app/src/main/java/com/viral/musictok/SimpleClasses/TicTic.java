package com.viral.musictok.SimpleClasses;
...
import com.viral.musictok.ActivitesFragment.CustomErrorActivity;
import com.viral.musictok.ActivitesFragment.LiveStreaming.Constants;
import com.viral.musictok.ActivitesFragment.LiveStreaming.rtc.AgoraEventHandler;
...
import com.viral.musictok.ActivitesFragment.LiveStreaming.utils.FileUtil;
import com.viral.musictok.ActivitesFragment.LiveStreaming.utils.PrefManager;
import com.viral.musictok.ActivitesFragment.Profile.Setting.NoInternetA;
...
import static com.viral.musictok.SimpleClasses.ImagePipelineConfigUtils.getDefaultImagePipelineConfig;


/**
 * Created by viral on 3/18/2019.
 */
...
public class TicTic extends Application implements Application.ActivityLifecycleCallbacks, BackgroundDetectorHandler.OnVisibilityChangedListener {
        ...
        if (Functions.getSharedPreference(getApplicationContext()).getBoolean(Variables.IS_LOGIN,false))
        {
            rootref.child(Variables.onlineUser).child(Functions.getSharedPreference(getApplicationContext()).getString(Variables.U_ID,"0"))
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    Log.d(com.viral.musictok.Constants.tag,"removeOnlineStatus: "+Functions.getSharedPreference(getApplicationContext()).getString(Variables.U_ID,"0"));
                };
            });
        ...
        if (Functions.getSharedPreference(getApplicationContext()).getBoolean(Variables.IS_LOGIN,false))
        {
            ...
            rootref.child(Variables.onlineUser).child(Functions.getSharedPreference(getApplicationContext()).getString(Variables.U_ID,"0")).setValue(onlineModel)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            Log.d(com.viral.musictok.Constants.tag,"addOnlineStatus: "+onlineModel.getUserId());
                        };
                    });
        ...
        FirebaseMessaging.getInstance().getToken()
                .addOnCompleteListener(new OnCompleteListener<String>() {
                    ...
                    public void onComplete(@NonNull Task<String> task) {
                        ...
                        Log.d(com.viral.musictok.Constants.tag,"token: "+token);
    ...
    {
        Log.d(com.viral.musictok.Constants.tag,"onAppGoesToBackground");
        removeOnlineListener();
    }
    ...
    {
        Log.d(com.viral.musictok.Constants.tag,"onAppGoesToForeground");
        addOnlineListener();
    }
